...
const file_trip_proto_rawDesc = "" +
	...
	"\x04Trip\x12+\n" +
	"\x06routes\x18\x01 \x03(\v2\x13.valhalla.TripRouteR\x06routesBIH\x03ZEmatching-engine/internal/adapter/routing-engine/valhalla/client/pb;pbP\x00P\x01b\x06proto3"
