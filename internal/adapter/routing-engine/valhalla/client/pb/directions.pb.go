...
const file_directions_proto_rawDesc = "" +
	...
	"\n" +
	"Directions\x121\n" +
	"\x06routes\x18\x01 \x03(\v2\x19.valhalla.DirectionsRouteR\x06routesBIH\x03ZEmatching-engine/internal/adapter/routing-engine/valhalla/client/pb;pbP\x00P\x01b\x06proto3"
