...
const file_sign_proto_rawDesc = "" +
	...
	"\x18guidance_view_signboards\x18\t \x03(\v2\x19.valhalla.TripSignElementR\x16guidanceViewSignboardsBIH\x03ZEmatching-engine/internal/adapter/routing-engine/valhalla/client/pb;pbP\x00b\x06proto3"
